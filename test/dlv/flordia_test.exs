defmodule FloridaTest do
  ...
  test ".validation should return false for an invalid format" do
    month = 5
    day = 15
    gender = "male" 
    assert validation("A123456789012", month, day, gender) == false
  end

  test ".validation should return true for a valid format" do
    month = 5
    day = 15
    gender = "male" 
    assert validation("A123456789175", month, day, gender) == true
  end
